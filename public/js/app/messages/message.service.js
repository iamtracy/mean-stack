...
var MessageService = (function() {
  ...
  MessageService.prototype.addMessage = function(message) {
    ...
    return this.http
      ...
      .map(function(response) {
        ...
        var message = new Message(result.obj.content, result.obj.firstName, result.obj._id, result.obj.user._id);
  ...
  MessageService.prototype.updateMessage = function(message) {
    ...
    var token = localStorage.getItem('token') ? '?token=' + localStorage.getItem('token') : '';
    return this.http
      .patch('https://angular4-messages.herokuapp.com/message/' + message.messageId + token, body, { headers: headers })
  ...
  MessageService.prototype.deleteMessage = function(message) {
    ...
    var token = localStorage.getItem('token') ? '?token=' + localStorage.getItem('token') : '';
    return this.http
      .delete('https://angular4-messages.herokuapp.com/message/' + message.messageId + token)
      .map(function(response) { return response.json(); })
      .catch(function(error) {
        _this.errorService.handleError(error.json());
        return Observable.throw(error);
